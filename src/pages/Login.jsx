...
export default function Login() {
  ...
  async function handleLogin() {
    try {
      const res = await axios.post('https://api.k4h.dev/auth/login', { email, password })
    ...
    <div className="flex justify-center items-center h-screen">
      <div className="w-[300px] h-[400px] border-2 border-black bg-gray-500">
        ...
        <div className="mt-6 flex flex-col items-center">
          ...
          <button
            onClick={handleLogin}
            className="mt-4 w-[150px] text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 rounded-base px-4 py-2.5"
          >
            Login
          </button>
        </div>
